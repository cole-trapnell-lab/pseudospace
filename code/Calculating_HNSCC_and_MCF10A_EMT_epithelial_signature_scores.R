...
hallmarksGSC <- loadGSCSafe(file="~/GeneSetCollections/GMT/EM_pathways/Human/symbol/Pathways/h.all.v6.0.symbols.gmt")
GOGSC<-loadGSCSafe(file="~/GeneSetCollections/GMT/EM_pathways/Human/symbol/GO/Human_GO_bp_no_GO_iea_symbol.gmt")
...
monocle:::monocle_theme_opts() +
ggsave(file = "HNSCC_MCF10A_Early_EMT_score_test.png", height = 4.2, width = 6)
...
monocle:::monocle_theme_opts() +
ggsave(file = "HNSCC_MCF10A_Late_EMT_score_test.png", height = 4.2, width = 6)
